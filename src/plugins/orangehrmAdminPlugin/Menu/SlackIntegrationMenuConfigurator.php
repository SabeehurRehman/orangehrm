...
/**
 * Menu configurator for Slack Integration settings page
 */
class SlackIntegrationMenuConfigurator implements MenuConfigurator
{
    ...
    {
        $this->getCurrentModuleAndScreen()->overrideScreen('viewSlackIntegration');
        return null;
    }
}
